...
class Replayer(UseCase):
    ...
    async def init(self):
        await self.log.init_websocket()  # we don't want to automatically start a run here
    ...
    async def run(self, configuration):
        ...
        for line in open(self.replay_file, "r"):
            ...
            if recording_start is None:
                ...
                await self.log.start_run(msg.message.data.model, msg.message.data.tag, msg.message.data.configuration, msg.at)
            ...
            print("sending")
            await self.log.send(msg.message.type, msg.message.data)
