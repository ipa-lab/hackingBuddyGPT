...
def get_history_table(enable_analysis: bool, enable_update_state: bool, run_id: int, db: DbStorage, turn: int) -> Table:
    ...
    for i in range(1, turn+1):
        table.add_row(*db.get_round_data(run_id, i, enable_analysis, enable_update_state))
